...
useEffect(() => {
	...
	return (
		<header class={`
			...
			z-10
		`}>
			<nav class="relative z-10 flex space-x-8 sm:space-x-4 font-custom text-black sm:text-2lg md:text-2xl lg:text-4xl">
				<div class="nav-left space-x-8 sm:space-x-4 flex font-custom text-black z-10">
